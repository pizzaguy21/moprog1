...
class QuizJapanesePage extends StatefulWidget {
  @override
  _QuizJapanesePageState createState() => _QuizJapanesePageState();
}

class _QuizJapanesePageState extends State<QuizJapanesePage> {
  ...
  void _startSplashSequence() async {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => JapaneseQuizContent()),
    );
  }
...
class JapaneseQuizContent extends StatefulWidget {
  @override
  _JapaneseQuizContentState createState() => _JapaneseQuizContentState();
}

class _JapaneseQuizContentState extends State<JapaneseQuizContent> {
  ...
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      "question": "What is the correct pronunciation of 'ありがとう'?",
      "options": ["Arigatou", "Arigeto", "Aregatou", "Arigoto"],
      "answer": 0,
    },
    {
      "question": "What does 'さようなら' mean?",
      "options": ["See you later", "Goodbye", "Thank you", "Hello"],
      "answer": 1,
    },
    {
      "question": "What is the meaning of 'はじめまして'?",
      "options": ["Nice to meet you", "Thank you", "Good evening", "Excuse me"],
      "answer": 0,
    },
    {
